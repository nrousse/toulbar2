...
toulbar2 won several competitions on Max-CSP (`CPAI08 <http://www.cril.univ-artois.fr/CPAI08/>`_) and probabilistic graphical models (UAI `2008 <http://graphmod.ics.uci.edu/uai08/Evaluation/Report/MPE>`_, `2010 <http://www.cs.huji.ac.il/project/UAI10/summary.php>`_, `2014 <http://auai.org/uai2014/competition.shtml>`_ MAP task).
